...
Cells in grey are unattested in \langname or impossible. Cells spanning multiple rows or column denote degrees of allophonic variation.

\begin{center}
\renewcommand{\arraystretch}{2.5}
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
\cline{3-9}
\multicolumn{2}{c|}{} & Labial & Dental & Apical & Palatal & Lateral & Velar & Uvular\\ \hline \hline
\multicolumn{2}{|c|}{Ejective} &\voidcell & \voidcell & \qcn{ṭʼ}  /ʈʼ/ & \qcn{cʼ} &  	 \qcn{tłʼ} /t͡ɬʼ/ & \voidcell &\qcn{qʼ}  \\ \hline \hline
\multirow{5}{*}{Pulmonic} & Stop & \qcn{p} & \multirow{2}{*}{\qcn{t/ts} /t͡s̪/}  & \qcn{ṭ} /ʈ/ & 	\qcn{j}/ɟ/ & \multirow{2}{*}{\qcn{tł} /t͡ɬ/}	 	&	\multirow{2}{*}{\qcn{k}} & \multirow{2}{*}{\voidcell}  \\ \cline{2-3} \cline{5-6} 
& Affricate & \voidcell &  & \qcn{tṣ} /ʈ͡ʂ/ & 	\qcn{č} /t͡ʃ/ & 	&  & \voidcell  	 \\ \cline{2-9}
& Trill & \voidcell & \voidcell & \qcn{r}/\qcn{rr} /r/ & \voidcell & \voidcell & \voidcell & \voidcell \\  \cline{2-9}
& Nasal & \qcn{m} &  \qcn{n} /n̪/ & \qcn{ṇ} /ɳ/ & \qcn{ñ} /ɲ/ & \qcn{l} & \multicolumn{2}{c|}{\qcn{ŋ} /ŋ \textasciitilde ɴ/}  \\ \cline{2-9}
& Glot. Stop & \multicolumn{7}{c|}{\qcn{ʼ}/ʔ/} \\ \hline \hline
\multirow{10}{*}{Click} & I & \qcn{ʘ}  & \qcn{ʇ} & \qcn{ǃ} & \qcn{ǂ} & \qcn{ǁ}  \\ \cline{2-7}
 & II & \voidcell & \qcn{ʇʼ} &\qcn{ǃ} & \qcn{ǂʼ} & \qcn{ǁʼ}  \\ \cline{2-7}
 & III & \voidcell  & \qcn{ʇx} &\qcn{ǃx} &\qcn{ǂx} & \qcn{ǁx}  \\ \cline{2-7}
 & IV & \voidcell & \qcn{ʇqʼ} &\qcn{ǃqʼ} &\qcn{ǂqʼ} & \qcn{ǁqʼ}  \\ \cline{2-7}
 & V &  \qcn{ɴʘ}   & \qcn{ɴʇ} &\qcn{ɴǃ} &\qcn{ɴǂ} & \qcn{ɴǁ}  \\ \cline{2-7}
 & VI &  \voidcell   & \qcn{ɴʇʼ} &\qcn{ɴǃʼ} &\qcn{ɴǂʼ} & \qcn{ɴǁʼ}  \\ \cline{2-7}
 & VII & \voidcell    & \qcn{ɴʇx} &\qcn{ɴǃx} &\qcn{ɴǂx} & \qcn{ɴǁx}  \\ \cline{2-7}
 & VIII & \voidcell    & \qcn{sʇ} &\qcn{šǃ} &\qcn{ṣǂ} & \qcn{łǁ}  \\ \cline{2-7}
 & IX &   \voidcell  & \qcn{sʇʼ} &\qcn{šǃʼ} &\qcn{ṣǂʼ} & \qcn{łǁʼ}  \\ \cline{2-7}
 & X &   \voidcell  & \qcn{sʇqʼ} &\qcn{šǃqʼ} &\qcn{ṣǂqʼ} & \qcn{łǁqʼ}  \\ \cline{1-7}
\end{tabular}
\end{center}

\subsection{Ejectives}

Consistently with the language-wide pattern of distinction of degree of glottalisation, \langname distinguishes a few ejective phonemes, all of which but \qcn{qʼ} are actually uncommon. Frontal (labial or dental) ejectives do not exist. The next three ejectives \qcn{ṭʼ, cʼ, tłʼ} parallel the pulmonic obstruents. [*kʼ] is notably missing; it is generally understood that this sound has merged into the palatal \qcn{cʼ}. 
...
\begin{itemize}
	...
	\item The much rarer bilabial click \qcn{ʘ}. It usually begins as labial and moves to labiodental, and has a loud, very noisy sound. A very limited set of manners of articulation is attested for \qcn{ʘ}, and it appears only in very few words. It likely originates from strong labialisation of other clicks.
\end{itemize}
