...
\immediate\write18{py ../makedictionary.py}
...
\begin{tabular}{*{22}{|c}|}
\hline
Lowercase & \qcn{ʇ}&\multirow{2}{*}{\qcn{ǃ}}&\multirow{2}{*}{\qcn{ǂ}}&\multirow{2}{*}{\qcn{ǁ}}&\multirow{2}{*}{\qcn{ʼ}}&\qcn{a}&\qcn{ã}&\qcn{à}&\qcn{b}&
\qcn{č}&\qcn{d}&\qcn{e}&\qcn{ẽ}&\qcn{è}&\qcn{i}&\qcn{ĩ}&\qcn{ì}&\qcn{j}&\qcn{k} &\qcn{l}&\qcn{ł}\\
Uppercase & \qcn{Ʇ}& & & & &\qcn{A}&\qcn{Ã}&\qcn{À}&\qcn{B}&
                    \qcn{Č}&\qcn{D}&\qcn{E}&\qcn{Ẽ}&\qcn{È}&\qcn{I}&\qcn{Ĩ}&\qcn{Ì}&\qcn{J}&\qcn{K} &\qcn{L}&\qcn{Ł}\\ \hline \hline
Lowercase & \qcn{m}&\qcn{n}&\qcn{ṇ}&\qcn{ň}&\qcn{ŋ}&\qcn{o}&\qcn{õ}&\qcn{ò}&\qcn{p}&\qcn{q}&\qcn{r}&\qcn{s}&
                    \qcn{š}&\qcn{ṣ}&\qcn{t}&\qcn{ṭ}&\qcn{u}&\qcn{ũ}&\qcn{ù}&\qcn{x}\\ 
Uppercase & \qcn{M}&\qcn{N}&\qcn{Ṇ}&\qcn{Ň}&\qcn{Ŋ}&\qcn{O}&\qcn{Õ}&\qcn{Ò}&\qcn{P}&\qcn{Q}&\qcn{R}&\qcn{S}&
...
2SG & Only one addressee &\qcn{uǃʼui} & \qcn{uči} & \qcn{ǃuũňi}\\ \hline
...
2PL & Addressee(s) (+ others) & \qcn{uǃʼui} & \qcn{uči} & \qcn{ǃuũṭa}\\\hline
\end{tabular}
\end{center}
