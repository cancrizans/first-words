...
Unstressed & (unspecified) & \qcn{a} & \qcn{e} & \qcn{i} & \qcn{o} & \qcn{u} & \multicolumn{2}{c|}{}\\ \cline{1-9}
\multirow{4}{*}{Stressed} & Plain  &\qcn{a(a)} & \qcn{e(e)} & \qcn{i(i)} & \qcn{o(o)} & \qcn{u(u)} & \qcn{au} & \\ \cline{2-8}
&Nasal &\qcn{aã} &  \multicolumn{2}{c|}{\qcn{iĩ}} & \qcn{oõ} & \qcn{uũ} & \qcn{aũ} &  \multirowcell{2}{\shortstack{\textit{etc for other} \\\textit{diphthongs}}}\\ \cline{2-8}
&Creaky  & \qcn{àa} & \qcn{èe} & \qcn{ìi} & \qcn{òo} & \qcn{ùu} & \qcn{àu} & \\ \cline{2-8}
&Nasal Creaky &\qcn{àã} &  \multicolumn{2}{c|}{\qcn{ìĩ}} & \qcn{òõ} & \qcn{ùũ} & \qcn{àũ} &  \\ \cline{1-9}
\end{tabular}
\end{center}
