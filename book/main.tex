...
\begin{center}
\transl{ʇala}{easily} \textrightarrow \transl{ʇaʇala}{more easily}
\end{center}
...
\gll ɴǃupaṇa nui\\
ɴǃupaṇa 	\CLF{person}\\
\glt ɴǃupaṇa (a person of unspecified gender).
\end{exe}
...
%	\gll ĩᵑǁa̰ ᵑǃUpaɳa t͡ɬa \\
	\gll iɴǁàa ɴǃupaṇa tła \\
	sleep ɴǃupaṇa \CLF{woman}\\
	\glt `ɴǃupaṇa is sleeping.'
\end{exe}
...
\begin{exe}
	\ex
	\gll ɴǃupaṇa 	tła 	iǃòorri 	šǃoiñe \\
		ɴǃupaṇa 	\CLF{woman} 	eat 	meat\\
	\glt `ɴǃupaṇa is eating meat'
\end{exe}
...
\begin{exe}
	\ex
	\gll ɴǃupaṇa 	tła  (ʼa)	iǃòorri  	šǃoiñe \\
		ɴǃupaṇa 	\CLF{woman} (\ERG) 	eat 	meat\\
	\glt `ɴǃupaṇa is eating meat'
\end{exe}
...
\begin{exe}
	\ex
	\gll  uji 	iǃòorri ɴǃupaṇa 	tła  \\
	ANTIP eat	ɴǃupaṇa 	\CLF{woman} 	\\
	\glt `ɴǃupaṇa is eating (nothing specific)'
\end{exe}
